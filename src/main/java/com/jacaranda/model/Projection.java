...
public class Projection {
	...
	@Override
	public int hashCode() {
		return Objects.hash(cinema, cip, premiere_date, room);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(cinema, other.cinema) && Objects.equals(cip, other.cip)
				&& Objects.equals(premiere_date, other.premiere_date) && Objects.equals(room, other.room);
	}

	@Override
	public String toString() {
		return "Projection [cinema=" + cinema + ", room=" + room + ", cip=" + cip + ", premiere_date=" + premiere_date
