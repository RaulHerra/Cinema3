			    ...
			    <div class="col-lg-8">
			      <div class="card border-0 rounded-3 shadow-lg">
			        <div class="card-body p-4">
			          ...
			          <form action="./confirmTickets.jsp">
			          ...
			          <%
			      		if(error != null){ //En el caso de haya un erro muestro el error y pongo un boton de volver a la lista%>
			       		...
			       		<%}%>
			            	...
			            	<input name="tickets" type="number" min="1"></input><br>
			            	<button class="btn btn-info" id="submitButton" type="submit">Buy tickets</button> <br>
					  </form>
